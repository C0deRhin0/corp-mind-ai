...
Usage:
    python main.py --dir /path/to/company/docs
    python main.py --dir /path/to/company/docs --reset   # wipes collection first
...
def main():
    parser = argparse.ArgumentParser(description="corp-mind-ai ingestion pipeline")
